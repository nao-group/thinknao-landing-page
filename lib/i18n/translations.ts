...
const en = {
  ...
  pricing: {
    ...
    heading1: "Invest in the destination.",
    heading2: "Start for free.",
    subheading:
      "No complicated plans. Begin with the essentials, then unlock the complete ThinkNAO journey when you are ready.",
    mostPopular: "MOST POPULAR",
    explorer: {
      name: "Explorer",
      tagline: "Build your first consistent study habit.",
      price: "Free",
      period: "forever",
      cta: "Start exploring",
      features: [
    ...
    climber: {
      name: "Climber",
      tagline: "Everything you need to master the CSCA.",
      price: "149k",
      period: "/ month",
...
const id: typeof en = {
  ...
  pricing: {
    ...
    heading1: "Investasikan untuk tujuanmu.",
    heading2: "Mulai gratis.",
    subheading:
      "Tidak ada paket rumit. Mulai dengan yang dasar, lalu buka semua fitur ThinkNAO saat kamu siap.",
    mostPopular: "PALING POPULER",
    explorer: {
      name: "Explorer",
      tagline: "Bangun kebiasaan belajar pertamamu yang konsisten.",
      price: "Gratis",
      period: "selamanya",
    ...
    climber: {
      name: "Climber",
      tagline: "Semua yang kamu butuhkan untuk menguasai CSCA.",
      price: "149k",
      period: "/ bulan",
      cta: "Coba gratis 7 hari",
      features: [
        "Latihan adaptif tak terbatas",
        "Asisten belajar AI",
        "Simulasi ujian penuh",
        "Penjelasan detail",
        "Hadiah papan peringkat bulanan",
      ],
    },
  },
  faq: {
...
const zh: typeof en = {
  ...
  pricing: {
    ...
    heading2: "免费开始。",
    subheading:
      "没有复杂的方案。从基础开始，准备好后解锁完整的ThinkNAO学习之旅。",
    mostPopular: "最受欢迎",
    explorer: {
      name: "Explorer",
      tagline: "建立您的第一个持续学习习惯。",
      price: "免费",
      period: "永久",
      cta: "开始探索",
      features: ["每日练习套题", "进度概览", "社区访问", "英语 + 汉语"],
    },
    climber: {
      name: "Climber",
      tagline: "掌握CSCA所需的一切。",
